...
const mobs:MonsterBlueprint[]=[
  ...
  M("hornBeast","초원의 뿔짐승","meadow",1,"boss",1500,28,250,"hornbeast","slam",[],[G("hornMace",40),G("hornShield",35),G("beastArmor",25)],[D("greatHorn",2.5,15,"확정 장비와 별도 판정")]),
  ...
  M("chiefUrk","족장 우르크","forest",2,"boss",6000,75,800,"chief","slam",[],[G("chiefMace",40),G("chiefShield",30),G("chiefArmor",30)],[D("greenKingSword",2,15)]),
  ...
  M("mineGuardian","광산의 수호자","mine",3,"boss",22000,250,2500,"guardian","slam",[],[G("guardianGreatsword",40),G("guardianShield",35),G("guardianArmor",25)],[D("deepCrusher",2,15)]),
  ...
  M("mistWitch","독안개 마녀","swamp",4,"boss",85000,950,8000,"witch","ranged",[],[G("mistDagger",40),G("mistShield",35),G("grayArmor",25)],[D("grayMoon",1.8,15)]),
  ...
  M("warlord","전쟁군주","canyon",5,"boss",350000,3800,25000,"warlord","slam",[],[G("warlordGreatsword",45),G("warlordArmor",30),G("warlordShield",25)],[D("bloodCrusher",1.5,15)]),
  ...
  M("frozenColossus","빙결의 거수","frost",6,"boss",1400000,13000,75000,"colossus","slam",[],[G("frozenGreatsword",40),G("frozenShield",35),G("frozenArmor",25)],[D("eternalIce",1.2,15)]),
  ...
  M("forgeLord","용광로의 군주","volcano",7,"boss",5500000,58000,220000,"forgeLord","slam",[],[G("forgeMace",40),G("forgeShield",30),G("forgeArmor",30)],[D("sunCrusher",1,15)]),
  ...
  M("ironKing","철왕 발테르","fortress",8,"boss",50000000,250000,650000,"ironKing","slam",[],[G("ironKingGreatsword",40),G("ironKingShield",30),G("ironKingArmor",30)],[D("kingbane",.8,15)]),
];
