# IRON CROWN v3 — GitHub Pages + Render 완성 배포판
...
v3는 다른 플레이어·보스의 delta time 보간, 지역별 compact snapshot, 보스 방송 묶음 처리, 협동 보상, 휴대폰 가로 전용 HUD, 다른 기기 로그인, 보스 피해 상한 문제를 수정했습니다. 원인과 전후 계측값은 `ONLINE-PERFORMANCE-UPDATE-KR.md`에 있습니다.
