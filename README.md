# IRON CROWN v5 — GitHub Pages + Render 완성 배포판
...
v5는 v4의 온라인·보스 최적화를 그대로 유지하면서 휴대폰 가로 월드 시야를 0.55로 넓히고, 서버 권위 장비 삭제와 공통 게임 확인 모달을 추가했습니다. 최신 변경과 검증 결과는 `V5-UPDATE-REPORT-KR.md`에 있습니다.
